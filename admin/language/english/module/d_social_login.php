...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="wrap-5">
      ...
      <div class="nav nav-tabs htabs tabs-md">
        <a href="#google_plus"  data-toggle="tab"><i class="fa fa-google-plus"></i> Google+</a>
        <a href="#facebook" class="htab-item" data-toggle="tab"><i class="fa fa-facebook"></i> Facebook</a>
        <a href="#twitter" class="htab-item" data-toggle="tab"><i class="fa fa-twitter"></i> Twitter</a>
        <a href="#windows_live" class="htab-item" data-toggle="tab"><i class="fa fa-windows"></i> Live</a>
        <a href="#linkedin" class="htab-item" data-toggle="tab"><i class="fa fa-linkedin"></i> Linkedin</a>
        <a href="#vkontakte" class="htab-item" data-toggle="tab"><i class="fa fa-vk"></i> vkontakte</a>
        <a href="#yandex" class="htab-item" data-toggle="tab"><i class="dsl-yandex"></i> Yandex</a>
        <a href="#paypal" class="htab-item" data-toggle="tab"><i class="fa fa-paypal"></i> Paypal</a>
        <a href="#instagram" class="htab-item" data-toggle="tab"><i class="fa fa-instagram"></i> Instagram</a>
        <a href="#tumblr" class="htab-item" data-toggle="tab"><i class="fa fa-tumblr"></i> Tumbler</a>
        <a href="#yahoo" class="htab-item" data-toggle="tab"><i class="fa fa-yahoo"></i> Yahoo</a>
        <a href="#foursquare" class="htab-item" data-toggle="tab"><i class="fa fa-foursquare"></i> Foursquare</a>
      </div>
      ...
      <div class="tab-content">
        <div id="google_plus" class="tab-pane active">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your Redirect URL</h4><p>'.HTTP_CATALOG.'d_social_login.php?hauth.done=Google</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login.php?hauth.done=Google</p></div>
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Attention!</h4><p>If you get an error from google, or a white screen- please check that you compleated all the steps.</p></div>
            <ol>
        ...
        <div id="twitter" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your Website and Callback url</h4><p>'.HTTP_CATALOG.'</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'</p></div>
        ...
        <div id="linkedin" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your OAuth 2.0 Redirect urls URL</h4><p>'.HTTP_CATALOG.'</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'</p></div>
        ...
        <div id="windows_live" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>IMPORTANT: Live Fix</h4><p>Windows live has blocked the ability to add parems to the url for the callback. this is why this is the only social login that requires its own callback url.</p><h4>Your URL-Forwarding address</h4><p>'.HTTP_CATALOG.'d_social_login_live.php</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login_live.php</p></div>
        ...
        <div id="vkontakte" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your site address</h4><p>'.HTTP_CATALOG.'</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'</p></div>
        ...
        <div id="yandex" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your CallBack Url</h4><p>'.HTTP_CATALOG.'d_social_login.php?hauth.done=Yandex</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login.php?hauth.done=Yandex</p></div>
        ...
        <div id="paypal" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning callout callout-warning bs-callout bs-callout-warning"><h4>Your App return Url</h4><p>'.HTTP_CATALOG.'d_social_login.php?hauth.done=Paypal</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login.php?hauth.done=Paypal</p></div>
        ...
        <div id="instagram" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your OAuth redirect_uri</h4><p>'.HTTP_CATALOG.'d_social_login.php?hauth.done=Instagram</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login.php?hauth.done=Instagram</p></div>
        ...
        <div id="tumblr" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class="callout callout-warning bs-callout bs-callout-warning"><h4>Your Default callback URL</h4><p>'.HTTP_CATALOG.'d_social_login.php?hauth.done=Tumblr</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'d_social_login.php?hauth.done=Tumblr</p></div>
        ...
        <div id="yahoo" class="tab-pane">
          ...
          <div class="tab-body">
            ...
            <div class=" callout callout-warning bs-callout bs-callout-warning"><h4>Your Default callback URL</h4><p>'.HTTP_CATALOG.'</p><h4>Your Redirect URL for HTTPS</h4><p>'.HTTPS_CATALOG.'</p></div>
